package com.epicwuxia.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.epicwuxia.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.epicwuxia.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
